...
public interface Scheduler {
     ...
     * @throws SchedulerException
     */
    default void scheduleJobs(List<JobDetail> jobDetails, Trigger trigger, boolean replace) throws SchedulerException {
        throw new RuntimeException("Not support scheduleJobs in this Scheduler.");
    }
