...
public final class JobKey extends Key<JobKey> {
    ...
    public JobKey(List<JobKey> jobKeyList) {
        super("PackJobName", "PackJobNameGroup");
        this.isJobPack = true;
        this.jobKeyList = jobKeyList;
    }
    ...
    private boolean isJobPack;

    public boolean isJobPack() {
        return isJobPack;
    }

    public void setJobPack(boolean jobPack) {
        isJobPack = jobPack;
    }

    private List<JobKey> jobKeyList;

    public List<JobKey> getJobKeyList() {
        return jobKeyList;
    }

    public void setJobKeyList(List<JobKey> jobKeyList) {
        this.jobKeyList = jobKeyList;
    }

    @Override
    public String getName() {
        return isJobPack ? getPackName() : super.getName();
    }

    @Override
    public String getGroup() {
        return isJobPack ? getPackGroup() : super.getGroup();
    }


    public String getPackName() {
        Collections.sort(jobKeyList);
        //TODO 优化字符串
        return jobKeyList.stream().map(x -> x.getName()).toString();
    }

    public String getPackGroup() {
        Collections.sort(jobKeyList);
        //TODO 优化字符串
        return jobKeyList.stream().map(x -> x.getGroup()).toString();
    }
}
